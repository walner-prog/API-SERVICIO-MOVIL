...
var servicioSchema = _joi["default"].object({
  vehiculo_id: _joi["default"].number().required().messages({
  ...
  origen: _joi["default"].string().required().messages({
    'string.empty': 'El origen es obligatorio'
  }),
  destino: _joi["default"].string().required().messages({
    'string.empty': 'El destino es obligatorio'
  }),
  fecha_hora: _joi["default"].date().iso().required().messages({
    'date.base': 'La fecha y hora deben ser una fecha válida',
    'date.empty': 'La fecha y hora son obligatorias'
  }),
  precio_final: _joi["default"].number().optional().messages({
    'number.base': 'El precio final debe ser un número',
    'number.empty': 'El precio final no puede estar vacío'
  }),
  estado: _joi["default"].string().valid('pendiente', 'negociando', 'aceptado', 'finalizado', 'cancelado').optional().messages({
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log('servicios', servicios), res.json(servicios);
          _context.next = 11;
          break;
        ...
        case 7:
          ...
          console.error('Error en index servicios:', _context.t0);
          res.status(500).json({
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 10:
          ...
          console.error('Error al registrar el servicio:', _context3.t0);
