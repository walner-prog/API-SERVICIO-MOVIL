...
exports.getEventosPrecioCero = exports.checkEventoExistsBySlug = exports.getEventosByUserId = exports.softDelete = exports.updateEvento = exports.create = exports.getById = exports.getProximosEventos = exports.getDestacados = exports.getAll = exports["default"] = void 0;
...
var EventoModel = {
  ...
  getDestacados: function getDestacados() {
    ...
    return regeneratorRuntime.async(function getDestacados$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return regeneratorRuntime.awrap(_db["default"].query("SELECT * FROM eventos WHERE deleted_at IS NULL AND destacado = 1"));
  ...
  getProximosEventos: function getProximosEventos() {
    var _ref5, _ref6, rows;

    return regeneratorRuntime.async(function getProximosEventos$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return regeneratorRuntime.awrap(_db["default"].query("SELECT * FROM eventos WHERE deleted_at IS NULL AND destacado IS true AND fecha_inicio >= CURDATE() - INTERVAL 1 MONTH"));
  ...
  getEventosPrecioCero: function getEventosPrecioCero() {
    var _ref7, _ref8, rows;

    return regeneratorRuntime.async(function getEventosPrecioCero$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return regeneratorRuntime.awrap(_db["default"].query("SELECT * FROM eventos WHERE deleted_at IS NULL AND precio = 0"));
  ...
  getById: function getById(id, userId) {
    var _ref9, _ref10, rows;

    return regeneratorRuntime.async(function getById$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return regeneratorRuntime.awrap(_db["default"].query("\n      SELECT e.* FROM eventos e\n      JOIN empresas em ON e.empresa_id = em.id\n      WHERE e.id = ? AND e.deleted_at IS NULL AND em.user_id = ?\n      ", [id, userId]));
  ...
  create: function create(evento) {
    var empresa_id, user_id, titulo, slug, descripcion, fecha_inicio, fecha_fin, ubicacion, precio_entrada, estado, imagen_destacada, _ref11, _ref12, result;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 14:
            ...
            throw new Error("Error al crear el evento: ".concat(_context6.t0.message));
  ...
  updateEvento: function updateEvento(id, evento) {
    var titulo, slug, descripcion, fecha_inicio, fecha_fin, ubicacion, precio_entrada, estado, imagen_destacada, _ref13, _ref14, result;

    return regeneratorRuntime.async(function updateEvento$(_context7) {
      while (1) {
  ...
  softDelete: function softDelete(id, user_id) {
    var _ref15, _ref16, result;

    return regeneratorRuntime.async(function softDelete$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _context8.next = 2;
            return regeneratorRuntime.awrap(_db["default"].query("UPDATE eventos SET deleted_at = NOW() WHERE id = ? AND user_id = ? AND deleted_at IS NULL", [id, user_id]));
  ...
  getEventosByUserId: function getEventosByUserId(userId) {
    var _ref17, _ref18, rows;

    return regeneratorRuntime.async(function getEventosByUserId$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            _context9.next = 2;
            return regeneratorRuntime.awrap(_db["default"].query("\n      SELECT e.* FROM eventos e\n      JOIN empresas em ON e.empresa_id = em.id\n      WHERE em.user_id = ? AND e.deleted_at IS NULL AND em.deleted_at IS NULL\n      ", [userId]));
  ...
  checkEventoExistsBySlug: function checkEventoExistsBySlug(slug) {
    var _ref19, _ref20, rows;

    return regeneratorRuntime.async(function checkEventoExistsBySlug$(_context10) {
      while (1) {
...
var getAll = EventoModel.getAll,
    getDestacados = EventoModel.getDestacados,
    getProximosEventos = EventoModel.getProximosEventos,
    ...
    getEventosByUserId = EventoModel.getEventosByUserId,
    checkEventoExistsBySlug = EventoModel.checkEventoExistsBySlug,
    getEventosPrecioCero = EventoModel.getEventosPrecioCero;
exports.getEventosPrecioCero = getEventosPrecioCero;
exports.checkEventoExistsBySlug = checkEventoExistsBySlug;
exports.getEventosByUserId = getEventosByUserId;
exports.softDelete = softDelete;
exports.updateEvento = updateEvento;
exports.create = create;
exports.getById = getById;
exports.getProximosEventos = getProximosEventos;
exports.getDestacados = getDestacados;
